...
public class SimonSays extends KeyAdapter {
	...
	private void makeAlbum() {
		...
		images.put(new Integer(KeyEvent.VK_UP), "downarrow.jpg");
		images.put(new Integer(KeyEvent.VK_UP), "leftarrow.jpg");
	...
	public void keyPressed(KeyEvent e) {
		...
		// score
		 if (keyCode == imageIndex) {
			 points = points + 1;
			JOptionPane.showMessageDialog(null, "Simon Says your score is " + points + "points.");
		}
		
		// 18. if the keyCode doesn't match the imageIndex and "Simon didn't say..."
		// increase their score
		 else
			 JOptionPane.showMessageDialog(null, "Simon did not increase your score"); 
